...
import com.kylin.rest.annotation.RestLog;
import com.kylin.rest.util.ComUtil;
import com.kylin.rest.util.StringUtil;
...
public class ParameterCheckAspect {
     ...
     * 防止XSS攻击
     */
    @Pointcut("execution(* com.kylin.rest.controller..*(..))  ")
    public void preventXSS() {
    }
    /**
     * Log注解
     */
    @Pointcut("@annotation(com.kylin.rest.annotation.RestLog)")
    public void recordLog(){
    }
    /**
     * 验证参数
     */
    @Pointcut("@annotation(com.kylin.rest.annotation.ValidationParam)")
    ...
    public Object validationPoint(ProceedingJoinPoint pjp)throws Throwable{
        ...
        boolean  isLogEmpty  = Objects.isNull(method.getAnnotation( RestLog.class ));
