...
public class DateTimeUtil {
    ...
    public final static String ISO_DATE2 					= "yyyyMMdd";
    ...
    public static String smartFormat(Date date)
    {
        ...
        else
        {
            try
            {
                dateStr = formatDate(date, ISO_DATE_HOUR24_MIN_SEC);
                // 时分秒
    ...
    public static Date smartFormat(String text)
    {
        ...
        try
        {
            ...
            {
                date = formatStringToDate(text, ISO_DATE);
            }
            ...
            {
                date = formatStringToDate(text, ISO_DATE_HOUR24_MIN);
            }
            else if (text.length() == 19)
            {
                date = formatStringToDate(text, ISO_DATE_HOUR24_MIN_SEC);
            }
            else
            {
    ...
    public static Date formatStringToDate(String argDateStr, String argFormat) throws Exception
    {
        ...
        if (ComUtil.isEmpty(strFormat))
        {
            strFormat = ISO_DATE;
            if (argDateStr.length() > 16)
            {
                strFormat = ISO_DATE_HOUR24_MIN_SEC;
            }
            else if (argDateStr.length() > 10)
            {
                strFormat = ISO_DATE_HOUR24_MIN;
            }
        }
    ...
    {
        Date startDate = format(startDay,ISO_DATE);;
        Date endDate = format(endDay,ISO_DATE);
    ...
    {
        Date theStartDate =format(startDate,ISO_DATE);
        Date endDate = addDays(theStartDate, days);
        return format(endDate,ISO_DATE);
    }
    ...
    {
        return format(date, DateTimeUtil.ISO_DATE2);
    }
    ...
    {
        if (ComUtil.isEmpty(strDate) || ComUtil.isEmpty(dateFormat) )
        {
            return strDate;
        }
        //Convert a global string date to be a Date with default date formatter
        Date date = format(strDate, ISO_DATE);
