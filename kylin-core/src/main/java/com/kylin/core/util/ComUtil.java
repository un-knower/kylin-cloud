...
public class ComUtil {
    ...
    public static boolean equalsWithTrim(String str1, String str2) {
        return ComUtil.trim(str1).equals(ComUtil.trim(str2));
    }
    ...
    public static boolean equalsIgnoreCaseWithTrim(String str1, String str2) {
        return ComUtil.trim(str1).equalsIgnoreCase(ComUtil.trim(str2));
    }
     ...
     * @return
     */
    public static String formatValidationResult(Map<String, String> map) {
        StringBuilder returnStr = new StringBuilder();
        Set<String> set = map.keySet();
        for (String str : set) {
            returnStr.append(map.get(str) + ",");
        }
        if(set.size()>0){
